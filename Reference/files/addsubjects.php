    ...
    if (isset($_POST['subjectexcel'])) {
        if (empty($_FILES['file']['tmp_name'])) {
            ...
            while (!feof($handle)) {
                ...
                $type = $filesop[2];
                $semester = $filesop[3];
                $is_Alloted_to = $filesop[4];
                if ($code == "" || $code == "Subject Code") {
                    continue;
                }
                $q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
                    "INSERT INTO subjects VALUES ('$code','$name','$type','$semester','$is_Alloted_to')");
            }
        }
    }
    ?>
            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subjectcode" name="SC" placeholder="CSE...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        <label for="subjectallotment">Subject Allotment</label>
                        <input type="text" class="form-control" id="subjectallotment" name="SA"
                               placeholder="subject's allotment ...">
                    </div>
