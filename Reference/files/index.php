...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM,CSE DEPARTMENT,JKKNIU</h3>
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="1"> B.Sc I Year ( Semester I )</option>
            <option value="3"> B.Sc II Year ( Semester III )</option>
            <option value="5"> B.Sc III Year ( Semester V )</option>
           <option value="7"> B.Sc IV Year ( Semester VII )</option>
            <option value="8"> B.Sc IV Year ( Semester VIII )</option>
        </select>
    ...
    <div class="modal-content">
        ...
        <div style="display:none" id="facultyForm">
            <form action="facultyformvalidation.php" method="POST" style="overflow: hidden">
                <div class="form-group">
                    <label for="t_id">Teacher's_ID</label>
                    <input type="text" class="form-control" id="t_id" name="FN" placeholder="Teacher's_id. ...">
                </div>
                <div align="right">
    ...
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">OUR DEPARTMENT </h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Professor Dr.Mst Jannatul Ferdous</h3>
                    <hr/>
                    <h4 align="center">Head<br/>Computer Science & Engineering Department</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Professor Dr.Mst Jannatul Ferdous</h3>
                    <hr/>
                    <h4 align="center">Dean<br/>Computer Science & Engineering Department </h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Professor Dr.Mst Jannatul Ferdous</h3>
                    <hr/>
                    <h4 align="center">Chairman<br/>Computer Science & Engineering Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>Bangladesh</h4>
                <h4><strong>PABX Telephone:</strong>09032-56212,56214,56217,56217,56245,56247,56248,56271  </h4>
