    ...
    <div style="margin-top: 100px" align="center">
        <select name="select_teacher" class="list-group-item">
            ...
            while ($row = mysqli_fetch_assoc($q)) {
                echo " \"<option value=\"{$row['Teacher's_ID']}\">{$row['name']}</option>\"";
            }
            ?>
        </select>
    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">12:30-01:30</td>
                <td style="text-align:center">01:30-02:30</td>
                <td style="text-align:center">02:30-03:30</td>
                <td style="text-align:center">03:30-4:30</td>
            </tr>
            <tr>
                <?php
                $table = null;
                            ...
                            if ($r['isAlloted'] == 1 && $r['semester'] == $_POST['select_semester']) {
                                ...
                                if (isset($r['allotedto'])) {
                                    ...
                                    $qqq = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
                                        "SELECT * FROM teachers WHERE Teacher's_ID = '$id'");
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period7']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER SCIENCE & ENGINEERING DEPARTMENT, JKKNIU.";
