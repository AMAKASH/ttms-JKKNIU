            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">ALLOTMENT
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href=allotpracticals.php>LAB COURSES</a>
                        </li>
                        <li>
    ...
    if (isset($_POST['teacherexcel'])) {
        if (empty($_FILES['file']['tmp_name'])) {
            ...
            while (!feof($handle)) {
                ...
                $contact = $filesop[4];
                $email = $filesop[5];
                if ($t_id == "" || $t_id == "Teacher's_ID.") {
                    continue;
                }
                $q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
                    "INSERT INTO teachers VALUES ('$t_id','$name','$alias','$designation','$contact','$email')");
                if ($q) {
                    $sql = "CREATE TABLE " . $t_id ." (
				...
				period7 VARCHAR(30)
                    ...
                    for ($i = 0; $i < 6; $i++) {
                        $day = $days[$i];
                        $sql = "INSERT into " . $t_id . " VALUES('$day','','','','','')";
                        mysqli_query(mysqli_connect("localhost", "root", "", "ttms"), $sql);
                    }
                }
            }
        ...
        <div class="modal-body" id="EnterTeacher">
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="TF">Teacher's_ID</label>
                        <input type="text" class="form-control" id="Teacher's_ID" name="TF" placeholder="Teacher's_ID ...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="designation" name="TD">
                            ...
                            <option value="Guest Department">Guest Teacher</option>
                        </select>
                    </div>
                    <div class="form-group">
...
<div>
    ...
    <table id=teacherstable style="margin-left: 80px">
        ...
        while ($row = mysqli_fetch_assoc($q)) {
            echo "<tr><td>{$row['Teacher's_ID']}</td>
                    <td>{$row['name']}</td>
                    <td>{$row['alias']}</td>
