                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">ALLOTMENT
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href=allotsubjects.php>COURSES</a>
                            </li>
    ...
    <form action="allotclasses.php" method="post" style="margin-top: 100px">
        ...
        <div align="center">
            <select name="course" class="list-group-item">
                ...
                <option value="2"> B.Sc 1st Year Second Semester</option>
                <option value="3"> B.Sc 2nd Year First Semester</option>
                <option value="4"> B.Sc 2nd Year Second Semester</option>
                <option value="5"> B.Sc 3rd Year First Semester</option>
                <option value="6"> B.Sc 3rd Year Second Semester</option>
    ...
    <div align="center">
        ...
        <table id=allotedclassroomstable>
            ...
            <tbody>
                ...
                $courses = array('B.Sc 1st Year First Semester', 'B.Sc 1st Year Second Semester', 'B.Sc 2nd Year First Semester', 'B.Sc 2nd Year Second Semester', 'B.Sc 3rd Year First Semester', 'B.Sc 3rd Year Second Semester', 'B.Sc Final Year First Semester', 'B.Sc Final Year Second Semester');
                while ($row = mysqli_fetch_assoc($q)) {
                    if ($row['status'] == 0)
                        continue;
