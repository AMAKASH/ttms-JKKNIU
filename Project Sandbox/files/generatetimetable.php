                    ...
                    if (isset($_POST['select_semester']) || isset($_POST['select_teacher']) || isset($_GET['display'])) {
                        ...
                        if (isset($_POST['select_semester'])) {
                            ...
                            while ($r = mysqli_fetch_assoc($qq)) {
                                ...
                                } else if ($r['isAlloted'] == 1 && isset($r['alloted_to2']) && $r['alloted_to2'] == $tid) {
                                    $str .= $r['subject_code'] . ": " . $r['subject_name'] . " <br>";
                                } else if ($r['isAlloted'] == 1 && isset($r['alloted_to3']) && $r['alloted_to3'] == $tid) {
                                    $str .= $r['subject_code'] . ": " . $r['subject_name'] . " <br>";
                                }
                            }
                        }
